...
export declare type ActionElement = IButtonElement | IStaticSelectElement | IMultiStaticSelectElement | IOverflowElement | IDatePickerElement | ILinearScaleElement;
export declare type ContextElement = TextObject | IImageElement;
export declare type InputElement = IPlainTextInput | IStaticSelectElement | IMultiStaticSelectElement | IDatePickerElement | ILinearScaleElement;
